		...
		<div class="span24">
			...
			<form id="orderForm"
				...
				<input type="hidden" name="order.oid"
					value="<s:property value="order.oid"/>" />
				<div class="span24">
					<p>
						收货地址：<input name="order.addr" type="text"
							value="<s:property value="order.user.addr"/>"
							style="width: 350px" /> <br /> 收货人&nbsp;&nbsp;&nbsp;：<input
							name="order.name" type="text"
							value="<s:property value="order.user.name"/>"
							style="width: 150px" /> <br /> 联系方式：<input name="order.phone"
							type="text" value="<s:property value="order.user.phone"/>"
							style="width: 150px" />
