								...
								<input type="hidden" id="pageSize" name="pageSize" value="20">
									...
									<div class="pagination">
										...
										<c:if test="${pageBean.page != 1 }">
											<a
												href="${ pageContext.request.contextPath }/product_findByCid?cid=${cid }&page=1"
												class="firstPage">&nbsp;</a>
											<a
												href="${ pageContext.request.contextPath }/product_findByCid?cid=${cid }&page=${pageBean.page-1 }"
										...
										<c:forEach var="i" begin="1" end="${pageBean.totalPage }"
											...
											<c:if test="${pageBean.page!=i }">
												<a
													href="${ pageContext.request.contextPath }/product_findByCid?cid=${cid }&page=${i }">${i }
											</c:if>
										</c:forEach>

										<c:if test="${pageBean.page != pageBean.totalPage }">
											<a class="nextPage"
												href="${ pageContext.request.contextPath }/product_findByCid.action?cid=${cid }&page=${pageBean.page+1 }">&nbsp;</a>
											<a class="lastPage"
												href="${ pageContext.request.contextPath }/product_findByCid.action?cid=${cid }&page=${pageBean.totalPage}">&nbsp;</a>
										</c:if>
									</div>
			</form>
		</div>
