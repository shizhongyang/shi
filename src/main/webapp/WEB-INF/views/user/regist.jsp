...
<title>用户注册 - Powered By Mango Team</title>
...
<script type="text/javascript">
	...
	function checkForm() {
		...
		var x = document.getElementById("span1").innerText;
		//alert("x1="+x1);
		if (x == "此号码已经注册") {
			alert(x +"请登录！");
			return false;
		...
		var x1 = document.getElementById("span2").innerText;
		//alert("x1="+x1);
		if (x1 == "验证码错误") {
			alert(x1);
			return false;
	...
	/* function checkUserName() {
		...
		alert("----1");
		$("#span1").load(
				"${basePath}/user_checkUserName.action?"
						+ new Date().getTime(), {
					'username' : username
				});
					...
					<form id="registerForm" action="${basePath }myuser/regist"
						...
						<table border="1" >
							<tbody>
								<tr>
									<th>头像:</th>							
										<td style="margin-left: 100px" ><input  type="file" id="file" name="file" class="text"
											maxlength="100" onchange="changeImg()" /></td>
									<tr>
										<td align="center"><img id="img1"
											style="margin-left: 100px"
											src="${basePath}/image/1.jpg"
											width="42" height="42"></img></td>
									</tr>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>用户名:</th>
									<td><input type="text" id="username" name="name" placeholder="请输入登录名"
										class="text" maxlength="20" onblur="checkUserName()"  required/></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
									<td><input type="password" id="password" name="pwd" placeholder="请输入密码"
								...
								<tr>
									<th>身份证号:</th>
									<td><input type="text" name="idCard" class="text"
										maxlength="20"></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>E-mail:</th>
									<td><input type="text" id="email" name="email"
										class="text" maxlength="200" /> </span></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> <label> <input
												type="radio" name="gender" value="1">男 </label> <label>
								...
								<tr>
									<th>省份:</th>
									<td><input type="text" name="province" class="text"
										maxlength="30" required></td>
								</tr>
								<tr>
									<th>城市:</th>
									<td><input type="text" name="city" class="text"
										maxlength="30" required></td>
								</tr>
								<tr>
									<th>社区:</th>
									<td><input type="text" name="districtOrCounty" class="text"
										maxlength="100"></td>
								</tr>
								
								<tr>
									<th>地址:</th>
									<td><input type="text" name="location" class="text"
										maxlength="100"></td>
								</tr>
								<tr>
								...
								<tr>
									<th>&nbsp;</th>
									<td>提交 <input type="submit" value="同意以下协议并注册"></td>
								</tr>
								<tr>
									<th>&nbsp;</th>
									<td>注册协议</td>
